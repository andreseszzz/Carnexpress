...
public class ClienteServiceImpl implements ClienteService {
    ...
    // ✅ Implementación real del método para buscar por token
    @Override
    public Optional<Cliente> obtenerPorToken(String token) {
        return clienteRepository.findByTokenRecuperacion(token);
    }
}
